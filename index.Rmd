...
visualize the countries we all connect with and share it with you. Over the course of the year we will enhance the map and use the data to provide relevant programming for you!
...
joined with the world.cities dataset which provides the longitude for latitude. If we plan to build on this
...
to be hosted our SharePoint seamlessly. 
If this project gains wide spread engagement at HOOPP it would be awesome to be able  
to share the same the tool with ERG's outside of HOOPP. Writing this tool 
using open source software makes this much easier to do. 

*Why not more features right away?*

We could use this tool as a working project layering the map with markers, shapes 
etc etc as the year goes on to keep people engaged with our group. Slowly adding features. 
...
This map simply marks the capital cities and labels the countries from of
the countries from the survey results. 
